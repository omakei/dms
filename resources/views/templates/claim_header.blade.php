...
<table width="100%">
    <tr>
        <td calspan="4" align="center"><img src="{{ public_path('nhif.png') }}" alt="Logo" width="120" height="120"></td>
        <td style="text-align: center;padding: 4px;">Form NHIF 2A <br/> Regulation 18(1)</td>
    </tr>
    <tr>
